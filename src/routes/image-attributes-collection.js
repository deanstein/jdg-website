...
const imageAttributesCollection = {
	...
	swe: {
		ccp_1: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		ccp_construction_60s70s_blue_mall_columns_ceiling: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		ccp_construction_unity_npc_1: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		ccp_exhibit: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		code_svelte_1: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		code_stylized: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		family_tree_stylized: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		family_tree_jdg_1: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		hashtag_generator_stylized: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		jdg_svelte_ui: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		json_to_html_stylized: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		forma_3d_spaces_1: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		forma_3d_spaces_2: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		forma_daylight_potential_1: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		forma_sun_hours_1: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		forma_wind_1: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		forma_wind_2: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		formit_0: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		formit_dynamo_1: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
		...
		formit_plugins_1: postProcessImageAttributes(
			instantiateObject(jdgImageAttributes, {
				imgSrc:
					'https://res.cloudinary.com/jdg-main/image/upload/v1727232499/jdg-website/swe/formit-plugins-1.jpg',
				imgCaption:
					'The FormIt Plugin Manager showing a series of plugins created by Josh Goldstein.'
			})
		)
	},
	...
	jdg_photo_2: postProcessImageAttributes(
		instantiateObject(jdgImageAttributes, {
			imgSrc:
				'https://res.cloudinary.com/jdg-main/image/upload/v1756528204/jdg-website/jdg-photo-2.jpg',
